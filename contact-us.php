...
<!-- Fav and touch icons -->
<link rel="carrent" sizes="144x144" href="assets/images/favicon-icon/carrent.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="assets/images/favicon-icon/apple-touch-icon-114-precomposed.html">
<link rel="carrent" sizes="72x72" href="assets/images/favicon-icon/carrent.png">
<link rel="carrent" href="assets/images/favicon-icon/carrent.png">
<link rel="shortcut icon" href="assets/images/favicon-icon/carrent.png">
...
<!--Contact-us-->
<section class="contact_us section-padding gray-bg">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>To Contact us:</h3>
